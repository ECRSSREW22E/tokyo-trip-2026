(() => {
  ...
  const directorySources = [
    ...
    ['dir-src-yodobashi-akiba','Yodobashi Akiba official floor guide','OFFICIAL','https://www.yodobashi-akiba.com/information/information_floor.html','Official current floor guide.'],
    ...
    ['dir-src-omotesando-hills','Omotesando Hills official shop list','OFFICIAL','https://www.omotesandohills.com/shops_restaurants/shops/','Official current tenant guide.'],
    ...
    ['dir-src-109','SHIBUYA109 official shop list','OFFICIAL','https://www.shibuya109.jp/shop/','Official current tenant guide.'],
    ...
    ['dir-src-yokohama-joinus','JOINUS official shop guide','OFFICIAL','https://www.sotetsu-joinus.com/shopguide','Official current tenant guide.'],
    ['dir-src-yokohama-mores','Yokohama MORE’S official notice','OFFICIAL','https://yokohama-mores.jp/','Official site announces the entire facility is closed on 2026-08-20.'],
    ...
    ['dir-src-adam','JUN official store directory','OFFICIAL','https://www.junonline.jp/','Official JUN group site; use its store search before visiting.'],
    ...
    ['dir-src-kicks-lab','KICKS LAB. official store guide','OFFICIAL','https://www.kickslab.com/pages/shop-info','Official branch address, opening hours and notices.'],
    ...
    ['dir-src-spinns-109','SPINNS SHIBUYA109 official tenant page','OFFICIAL_BRANCH','https://shibuya109.jp/topics/shops/spinns/','Current SHIBUYA109 branch evidence; 7F, 10:00–21:00.'],
  ...
  const shoppingVenues = [
    ...
    venue('v-yokohama-mores','Yokohama MORE’S','橫濱',5,'station-mall',['dir-src-yokohama-mores'],{nearestStation:'橫濱站西口',tripDateStatus:'CLOSED',tripDateNote:'官方公告 2026/8/20（四）全館休館；D5 請改逛 JOINUS、SOGO 或高島屋。',needsVerification:false}),
  ...
  const shoppingBrands = [
    ...
    B('b-comme-ca','COMME CA','FASHION',['MINIMAL','SMART_CASUAL'],['MEN','WOMEN','ADULT'],3,'HIGH','EVERGREEN',{officialUrl:'https://www.fivefoxes.co.jp/',needsVerification:true}),
    ...
    B('b-kicks-lab','KICKS LAB.','SNEAKERS',['SNEAKER','STREETWEAR'],['UNISEX','YOUNG_ADULT','COLLECTOR'],3,'HIGH','NICHE',{officialUrl:'https://www.kickslab.com/pages/shop-info',sourceIds:['dir-src-kicks-lab']}),
